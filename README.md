...
Type the following in the terminal: `brew install python@3.10`, then `brew install sqlite`, then `brew install python-tk`. Then type `python3 -m pip install 'gasp[games]'`. Then, start `python` and type in the following:
